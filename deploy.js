...
function transferProjectToRemote(failed, successful) {
  return ssh.putDirectory(
    '../riot-express-todo-list-starter',
    '/home/ubuntu/riot-express-todo-list-starter-temp',
    {
      recursive: true,
      concurrency: 1,
...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf riot-express-todo-list-starter-temp && mkdir riot-express-todo-list-starter-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'cp -r riot-express-todo-list-starter-temp/* riot-express-todo-list-starter/ && rm -rf riot-express-todo-list-starter-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd riot-express-todo-list-starter && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    ...
    .then(function() {
      console.log('Creating `riot-express-todo-list-starter-temp` folder.');
